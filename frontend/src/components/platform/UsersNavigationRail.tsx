              ...
              >
                <Link href="/platform/users/invite" className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-muted-foreground">Send invitations to new staff members</div>
                  </div>
                </Link>
              </Button>
            )}
            {can("platform_users.view_activity") && (
              <Button
                variant="outline"
                className="w-full justify-start"
                asChild
              >
                <Link href="/platform/users/activity" className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-muted-foreground">View user activity and audit logs</div>
                  </div>
                </Link>
              </Button>
            )}
            {can("platform_users.edit") && (
              <Button
                variant="outline"
                className="w-full justify-start"
                asChild
              >
                <Link href="/platform/users/bulk" className="flex items-center gap-2">
                  <Download className="h-4 w-4" />
                  <div className="text-left">
                    <div className="font-medium">Bulk Operations</div>
                    <div className="text-sm text-muted-foreground">Import/export user data</div>
                  </div>
                </Link>
              </Button>
            )}
            {can("platform_users.view_sessions") && (
              <Button
                variant="outline"
                className="w-full justify-start"
                asChild
              >
                <Link href="/platform/users/sessions" className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-muted-foreground">Monitor user sessions and logins</div>
                  </div>
                </Link>
              </Button>
            )}
