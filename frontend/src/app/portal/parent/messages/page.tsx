...
export default function ParentMessagesPage() {
  ...
  const handleSelectConversation = async (conversationId: string) => {
    ...
    try {
      ...
      // Ignore read failures so the conversation still opens.
    }
  };
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Messages"
        description="Contact school administration and follow conversation replies in one place"
      />
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Textarea
                ...
                placeholder="Write a message to school administration..."
                rows={4}
              />
              <Button
                className="w-full"
          ...
          <CardContent>
            {!selectedConversation ? (
              <div className="flex flex-col items-center justify-center gap-3 py-16 text-center text-sm text-muted-foreground">
                ...
                <p>Select a conversation to read replies from the school.</p>
              </div>
            ) : (
