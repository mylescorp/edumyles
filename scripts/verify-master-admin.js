 ...
 * 
 * This script verifies that ayany004@gmail.com has been added as a master admin
...
async function verifyMasterAdmin() {
  console.log("🔍 Verifying ayany004@gmail.com as Master Admin...");
  ...
  try {
    ...
    console.log("   - email: 'ayany004@gmail.com'");
    ...
    console.log("   - after.email: 'ayany004@gmail.com'");
    console.log("   - after.role: 'master_admin'");

    console.log("\n📱 To test access:");
    console.log("1. Log in as ayany004@gmail.com at /auth/login");
