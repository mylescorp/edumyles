...
export const OPTIONAL_MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    description: "Create, approve, schedule, publish, and analyze social media content across major platforms from EduMyles.",
    tier: "starter",
    category: "communications",
    isCore: false,
    iconName: "Share2",
    ...
    dependencies: ["sis", "communications"],
    documentation: "https://docs.edumyles.com/modules/social",
    pricing: { monthly: 15, annual: 150, currency: "USD" },
    support: { email: "support@edumyles.com", phone: "+254 700 000 000", responseTime: "24h" },
  },
  {
