...
import {
  Globe, Monitor, TrendingUp, Brain, Zap, Heart,
...
const steps = [
  { num: "01", title: "Apply", detail: "Send your CV and a short note on why EduMyles. No cover letter essays." },
  { num: "02", title: "Intro Call", detail: "30-minute chat with a team member. We want to know you as a person first." },
  { num: "03", title: "Paid Task", detail: "A small, paid take-home task relevant to the role. Max 3 hours. We respect your time." },
  { num: "04", title: "Team Interview", detail: "Meet 2–3 team members. No whiteboard puzzles — just real conversation." },
];
  ...
  return (
    <div style={{ color: "#212121" }}>
      ...
      >
        ...
        <div className="relative max-w-[1200px] mx-auto w-full">
          <div className="max-w-[760px]">
            ...
            <h1
              className="font-playfair font-bold leading-[1.1] mb-5"
              style={{ fontSize: "clamp(2.4rem, 5vw, 4rem)", color: "#ffffff" }}
            >
              Build the future of{" "}
              <em className="italic" style={{ color: "#E8A020" }}>African education.</em>
            </h1>
            <p
              className="font-jakarta font-light leading-[1.8] mb-8"
              style={{ fontSize: "18px", color: "#90CAF9", maxWidth: "600px" }}
            >
              We&apos;re a small, mission-driven team building software that transforms how schools across East Africa operate. If you care about education and love building great products, you&apos;ll fit right in.
            </p>
            ...
            {cultureCards.map((c) => (
              ...
              >
                <div
                  ...
                  style={{ background: "rgba(26,122,74,0.08)", border: "1px solid rgba(26,122,74,0.12)" }}
                >
                  <c.icon className="w-5 h-5" strokeWidth={1.5} style={{ color: "#1A7A4A" }} />
                </div>
                <h3 className="font-playfair font-bold text-[18px] mb-2" style={{ color: "#061A12" }}>
                  {c.title}
                </h3>
      ...
      <section id="roles" className="py-20 px-4" style={{ background: "#F3FBF6" }}>
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-14">
            ...
            >
              Open{" "}
              <em className="italic" style={{ color: "#E8A020" }}>Roles</em>
            </h2>
          ...
          <div className="flex flex-col gap-4">
            {roles.map((role) => (
              <div
                ...
                style={{ background: "#ffffff", border: "1px solid #e8f4ec", boxShadow: "0 2px 8px rgba(6,26,18,0.04)" }}
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 mb-3">
                      <h3 className="font-playfair font-bold text-[19px]" style={{ color: "#061A12" }}>
                        {role.title}
                      </h3>
                      <span
                    ...
                    <div className="flex flex-wrap gap-4 mb-4">
                      <span className="inline-flex items-center gap-1.5 font-jakarta text-[12.5px]" style={{ color: "#6B9E83" }}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {role.skills.map((s) => (
                        <span
                          ...
                          style={{ background: "#F3FBF6", color: "#0F4C2A", border: "1px solid #d4eade" }}
                        >
                          {s}
                        </span>
                      ))}
                  ...
                  <Link
                    ...
                    style={{ background: "#061A12", color: "#ffffff", border: "1.5px solid #061A12" }}
      ...
      <section className="py-20 px-4" style={{ background: "#ffffff" }}>
        <div className="max-w-[1000px] mx-auto">
          <div className="text-center mb-14">
            ...
            >
              Our Hiring{" "}
              <em className="italic" style={{ color: "#E8A020" }}>Process</em>
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step) => (
              ...
              >
                <div
                  className="w-14 h-14 rounded-full flex items-center justify-center font-playfair font-bold text-[18px] mx-auto mb-5"
                  style={{ background: "#E8A020", color: "#061A12" }}
                >
                  {step.num}
                </div>
      ...
      <section className="py-14 px-4" style={{ background: "#F3FBF6" }}>
        <div className="max-w-[1000px] mx-auto">
          <h3 className="font-playfair font-bold text-center text-[22px] mb-10" style={{ color: "#061A12" }}>
            Perks &amp; Benefits
          </h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={b} className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 flex-shrink-0 mt-0.5" strokeWidth={2} style={{ color: "#1A7A4A" }} />
                <span className="font-jakarta text-[13.5px]" style={{ color: "#374151" }}>{b}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4" style={{ background: "#061A12" }}>
        <div className="max-w-[700px] mx-auto text-center">
          ...
          >
            Don&apos;t see your role?{" "}
            <em className="italic" style={{ color: "#E8A020" }}>We still want to hear from you.</em>
          </h2>
          <p className="font-jakarta text-[16px] leading-[1.7] mb-8" style={{ color: "#A8E6C3" }}>
            We&apos;re always looking for exceptional people. Send us your CV and tell us how you&apos;d contribute to EduMyles.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              ...
              style={{ background: "transparent", border: "2px solid rgba(255,255,255,0.3)", color: "#ffffff" }}
            >
              Learn About Us
            </Link>
          </div>
