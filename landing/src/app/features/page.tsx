...
const integrations: IntegrationEntry[] = [
  ...
  },
  {
    ...
    logo: CreditCard,
    desc: "Credit/debit card payments for international families",
    isEmoji: false,
  },
  {
    name: "WorkOS",
    region: "Global",
    logo: KeyRound,
    desc: "Enterprise SSO, MFA, and authentication",
    isEmoji: false,
  },
  {
    name: "Cloudinary",
    region: "Global",
    logo: Cloud,
    desc: "Image and document storage for student files",
    isEmoji: false,
  },
  {
    name: "Resend",
    region: "Global",
    logo: Mail,
    desc: "Transactional email delivery at scale",
    isEmoji: false,
  },
  {
    name: "Convex",
    region: "Global",
    logo: Zap,
    desc: "Real-time database powering instant sync",
    isEmoji: false,
  },
];
