...
export const metadata: Metadata = {
  ...
  description:
    "Explore all 13 integrated EduMyles modules — student information, admissions, finance, timetable, academics, HR, library, transport, communications, user management, support tickets, eWallet, and school shop.",
};
...
const platformHighlights: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    ...
    desc: "Every update reflects instantly across all devices and dashboards. No page refreshes needed.",
  },
  {
    icon: ShieldCheck,
...
const modules: {
  ...
  },
  {
    ...
    desc: "Invite users, assign roles, and control access across every portal and campus from one dashboard.",
    features: [
      "Staff and parent invites",
  ...
  },
  {
    ...
    desc: "Track school support requests from staff, parents, and students with clear ownership and resolution history.",
    features: [
      "Ticket intake",
...
const integrations: IntegrationEntry[] = [
  {
    ...
    region: "Kenya",
    logo: "🇰🇪",
    desc: "Mobile money — the primary payment method for Kenyan schools",
    isEmoji: true,
  },
  {
    name: "Airtel Money",
    region: "EA Region",
    logo: "🌍",
    desc: "Mobile money for Uganda, Tanzania, Rwanda, and Zambia",
    isEmoji: true,
  },
  {
    name: "SMS Gateway",
    region: "Pan-Africa",
    logo: Radio,
    desc: "SMS & USSD messaging for parent communications",
    isEmoji: false,
  },
  {
    name: "Card Payments",
    ...
    logo: CreditCard,
    desc: "Credit and debit card payments for international families",
    isEmoji: false,
  },
  {
    name: "Single Sign-On",
    region: "Global",
    logo: KeyRound,
    desc: "Enterprise SSO, MFA, and secure authentication",
    isEmoji: false,
  },
  {
    ...
    region: "Global",
    logo: Cloud,
    desc: "Secure image and document storage for school records",
    isEmoji: false,
  },
  {
    name: "Email Delivery",
    region: "Global",
    logo: Mail,
    desc: "Transactional email delivery for school workflows",
    isEmoji: false,
  },
  {
    name: "Live Data Sync",
    region: "Global",
    logo: Zap,
    desc: "Instant updates across portals and dashboards",
    isEmoji: false,
  },
];
    ...
    <div style={{ color: "#212121" }}>
      ...
      >
        ...
        <div className="relative max-w-[1200px] mx-auto w-full text-center">
          ...
          >
            13 integrated modules covering student management, finance, operations, HR,
            multi-campus, payments, and communication — all working together so your school runs
            itself.
          </p>
            ...
            {platformHighlights.map((h) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 2px 12px rgba(6,26,18,0.06)",
                }}
              >
                {/* Icon circle */}
                <div
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p
              ...
              style={{ color: "#5a5a5a", maxWidth: "540px", margin: "0 auto" }}
            >
              No data silos. No duplicate entry. One action in one module updates everything else
              automatically.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
            {modules.map((mod) => (
              ...
              >
                ...
                <div>
                  <h3
                    className="font-display font-bold text-[19px] leading-[1.3] mb-2"
                    style={{ color: "#061A12" }}
                  >
                    {mod.name}
                  </h3>
                  <p
                    className="font-jakarta text-[13.5px] leading-[1.75]"
                    style={{ color: "#5a5a5a" }}
                  >
                    {mod.desc}
                  </p>
      ...
      <section className="py-20 px-4" style={{ background: "#061A12" }} id="automation">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p
              className="font-jakarta text-[16px] leading-[1.7]"
              style={{ color: "#A8E6C3", maxWidth: "540px", margin: "0 auto" }}
            >
              EduMyles automates the work that eats your team&apos;s time — so you can focus on what
              matters: educating students.
            </p>
          </div>
      ...
      <section className="py-20 px-4" style={{ background: "#F3FBF6" }} id="integrations">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p
              className="font-jakarta text-[15px] leading-[1.7]"
              style={{ color: "#5a5a5a", maxWidth: "500px", margin: "0 auto" }}
            >
              Every integration is deeply connected — data flows automatically between tools, no
              manual syncing.
            </p>
          </div>
            ...
            {integrations.map((int) => (
              <div
                ...
                style={{
                  background: "#ffffff",
                  border: "1px solid rgba(38,166,91,0.15)",
                  boxShadow: "0 2px 10px rgba(6,26,18,0.05)",
                }}
              >
                ...
                <p className="font-jakarta text-[13px] leading-[1.65]" style={{ color: "#5a5a5a" }}>
                  {int.desc}
                </p>
              </div>
            ))}
