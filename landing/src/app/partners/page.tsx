        ...
        <div className="relative max-w-[800px] mx-auto text-center">
          ...
          <div className="max-w-[600px]">
            ...
            <p
              ...
              style={{ color: "#A8E6C3" }}
            >
              Join our partner ecosystem and help transform education across East Africa. 
              We work with technology providers, educational consultants, and service companies 
              to deliver comprehensive solutions to schools.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: "Integrate your tools with EduMyles and reach thousands of schools across East Africa.",
                benefits: [
              ...
              },
              {
                ...
                description: "Sell EduMyles to schools in your region and earn competitive commissions.",
                benefits: [
              ...
              },
              {
                ...
                description: "Help schools implement EduMyles and provide ongoing support services.",
                benefits: [
              ...
              <div key={partner.title} className="p-6 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center" style={{ background: "rgba(26,122,74,0.1)" }}>
                ...
                <ul className="space-y-2">
                  {partner.benefits.map((benefit) => (
                    <li key={benefit} className="flex items-center gap-2">
                      ...
                      <span className="font-jakarta text-sm" style={{ color: "#374151" }}>{benefit}</span>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                {
                  title: "Market Leader",
                  description: "Trusted by 500+ schools across Kenya, Uganda, Tanzania, Rwanda, and Zambia.",
                  stat: "500+ Schools"
                },
                {
                  title: "Growing Market",
                  description: "East African education market growing at 15% annually with increasing digital adoption.",
                  stat: "15% Annual Growth"
                },
                {
                  title: "Proven Platform",
                  description: "Battle-tested with real-world experience in diverse educational environments.",
                  stat: "5+ Years Experience"
                },
                {
                  title: "Local Support",
                  description: "On-ground teams and local expertise across all East African countries.",
                  stat: "4 Countries Covered"
                }
              ].map((item) => (
                <div key={item.title} className="p-6 rounded-xl" style={{ background: "#F3FBF6", border: "1px solid #d4eade" }}>
              ...
              {[
                {
                  ...
                  description: "Reach out to our partnerships team with your company information and partnership proposal."
                },
                {
                  step: "Step 2",
                  title: "Evaluation",
                  description: "We review your proposal and assess alignment with our mission and technical requirements."
                },
                {
                  step: "Step 3",
                ...
                },
                {
                  ...
                  description: "We provide training, resources, and support to ensure a successful partnership launch."
                }
              ].map((step) => (
                <div key={step.step} className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: "#E8A020", color: "#061A12" }}>
                      <span className="font-jakarta font-bold text-sm">{step.step.split(' ')[1]}</span>
                    </div>
                  </div>
                  <div>
                    <h3 className="font-jakarta font-bold text-lg mb-2" style={{ color: "#061A12" }}>
