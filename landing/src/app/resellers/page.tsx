...
const resellerBenefits = [
  {
    ...
    detail:
      "Sell under your own brand name. We provide a white-label version with your logo, colours, and custom domain — your clients never need to know EduMyles powers it.",
  },
  {
    icon: Banknote,
  ...
  },
  {
    ...
    detail:
      "We join your sales calls, provide demo accounts, and help close complex school deals alongside you.",
  },
  {
    icon: BarChart2,
    title: "Reseller Pricing",
    detail:
      "Buy EduMyles at a discounted rate, bundle with your services, and set your own margin on top.",
  },
  {
    icon: Shield,
    title: "Territory Protection",
    detail:
      "Request exclusivity for a region, county, or school network. First-come, first-served.",
  },
  {
    icon: Wrench,
    title: "Partner Dashboard",
    detail:
      "Real-time view of your schools, their usage, subscription status, and your monthly earnings — all in one place.",
  },
];
...
const steps = [
  {
    num: "01",
    title: "Apply online",
    detail: "2-minute form below. Tell us about your company and target market.",
  },
  {
    num: "02",
    title: "Get your partner kit",
    detail: "Training access, marketing assets, demo environment, and your dedicated manager.",
  },
  {
    num: "03",
    title: "Introduce EduMyles",
    detail: "Use your network, events, or direct outreach to connect schools with EduMyles.",
  },
  {
    num: "04",
    title: "Earn monthly commissions",
    detail: "Automatic M-Pesa or bank transfer payouts — no chasing invoices.",
  },
];
...
const testimonials = [
  {
    quote:
      "We bundled EduMyles with our school ICT setup service. Three schools in the first month alone — the commission covers our office rent.",
    name: "TechBridge East Africa",
    location: "Nairobi",
  },
  {
    quote:
      "The white-label feature was the game-changer. Our clients see our brand, we earn the EduMyles commission in the background. Perfect.",
    name: "EduTech Solutions KE",
    location: "Mombasa",
  },
  {
    quote:
      "As a school consultant, recommending EduMyles is a no-brainer. It's the best product and the 20% commission is a great ongoing bonus.",
    name: "Sarah M.",
      ...
      >
        ...
        <div className="relative max-w-[1200px] mx-auto w-full">
          <div className="max-w-[760px]">
            ...
            >
              Join 20+ active resellers earning monthly recurring commissions by bringing EduMyles
              to schools across East Africa. White-label available for resellers.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="#apply"
                className="inline-flex items-center gap-2 font-jakarta font-bold text-[15px] px-7 py-4 rounded-[50px] no-underline"
              ...
              <a
                href="#tiers"
                className="inline-flex items-center gap-2 font-jakarta font-semibold text-[15px] px-7 py-4 rounded-[50px] no-underline"
                style={{
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {tiers.map((t) => (
              <div
                ...
                style={{
                  background: t.featured ? "#061A12" : "#ffffff",
                  border: t.featured ? "2px solid #E8A020" : "1px solid #e8f4ec",
              ...
              >
                {t.featured && (
                  <div
                    className="text-center font-jakarta font-bold text-[11px] py-2"
                    style={{ background: "#E8A020", color: "#061A12" }}
                  >
                ...
                <div className="p-7 flex flex-col flex-1">
                  <div
                    ...
                    style={{ background: t.featured ? "rgba(232,160,32,0.15)" : "#F3FBF6" }}
                  >
                    <t.icon
                      className="w-6 h-6"
                      strokeWidth={1.5}
                      style={{ color: t.featured ? "#E8A020" : "#0F4C2A" }}
                    />
                  </div>
                  <h2
                    className="font-display font-bold text-[20px] mb-1"
                    style={{ color: t.featured ? "#ffffff" : "#061A12" }}
                  >
                    {t.title}
                  </h2>
                  <p
                    className="font-jakarta text-[11.5px] font-semibold uppercase tracking-wide mb-4"
                    style={{ color: t.featured ? "#6B9E83" : "#9ca3af" }}
                  >
                    For: {t.forWho}
                  </p>
                  <p
                    className="font-jakarta text-[13.5px] leading-[1.8] mb-5 flex-1"
                    style={{ color: t.featured ? "#A8E6C3" : "#5a5a5a" }}
                  >
                    {t.desc}
                  </p>
                  <div
                    ...
                    style={{
                      background: t.featured ? "rgba(232,160,32,0.1)" : "#F3FBF6",
                      border: `1px solid ${t.featured ? "rgba(232,160,32,0.25)" : "#d4eade"}`,
                    }}
                  >
                    <span
                  ...
                  <ul className="flex flex-col gap-2 mb-6">
                    {t.features.map((f) => (
                      <li
                        key={f}
                        className="flex items-start gap-2.5 font-jakarta text-[12.5px]"
                        style={{ color: t.featured ? "#A8E6C3" : "#5a5a5a", listStyle: "none" }}
                      >
                        <CheckCircle2
                          className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
                          strokeWidth={2}
                          style={{ color: t.featured ? "#26A65B" : "#1A7A4A" }}
                        />
                        {f}
                      </li>
                    ))}
                  ...
                  <a
                    ...
                    style={{
                      background: t.featured ? "#E8A020" : "#061A12",
                      color: t.featured ? "#061A12" : "#ffffff",
                    }}
                  >
                    {t.cta}
                  </a>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="grid gap-5">
              {resellerBenefits.map((b) => (
                ...
                >
                  ...
                  <div>
                    <h3
                      className="font-jakarta font-bold text-[14.5px] mb-1"
                      style={{ color: "#061A12" }}
                    >
                      {b.title}
                    </h3>
            ...
            <div
              ...
              style={{ background: "#061A12", border: "2px solid rgba(232,160,32,0.4)" }}
            >
              <div
              ...
              <h3 className="font-display font-bold text-[22px] text-white mb-2">
                Reseller Starter Kit
              </h3>
              <p className="font-jakarta text-[13.5px] mb-6" style={{ color: "#6B9E83" }}>
                What you receive on day one of approval:
              </p>
              <ul className="flex flex-col gap-3 mb-8">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-3 font-jakarta text-[13px] text-white"
              ...
              <a
                href="#apply"
                className="block text-center font-jakarta font-bold text-[14px] px-6 py-3.5 rounded-[50px] no-underline"
                style={{ background: "#E8A020", color: "#061A12" }}
              >
                Apply Now — It&apos;s Free →
              </a>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr style={{ background: "#061A12" }}>
                  {["Schools Onboarded", "Plan Mix", "Your Monthly Commission"].map((h) => (
                    <th
                      key={h}
                      className="font-jakarta font-bold text-[12px] text-left px-6 py-4"
                      style={{ color: "#E8A020" }}
                    >
                      {h}
                    </th>
              ...
              <tbody>
                {earnings.map((row, i) => (
                  ...
                  >
                    <td
                      className="font-jakarta font-semibold text-[14px] px-6 py-4"
                      style={{ color: "#061A12" }}
                    >
                      {row.schools}
                    </td>
                    <td
                      className="font-jakarta text-[13.5px] px-6 py-4"
                      style={{ color: "#5a5a5a" }}
                    >
                      {row.plan}
                    </td>
                    <td
                      className="font-display font-bold text-[16px] px-6 py-4"
                      style={{ color: i === earnings.length - 1 ? "#E8A020" : "#0F4C2A" }}
                    >
                      {row.monthly}
                    </td>
                  </tr>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div
                ...
                style={{ background: "#F3FBF6", borderLeft: "4px solid #E8A020" }}
              >
                <p
                  className="font-display italic text-[15px] leading-[1.8] flex-1 mb-5"
                  style={{ color: "#374151" }}
                >
                  &ldquo;{t.quote}&rdquo;
                </p>
                <div>
                  <p className="font-jakarta font-bold text-[13px]" style={{ color: "#061A12" }}>
                    {t.name}
                  </p>
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {faqs.map((faq) => (
              ...
              >
                <h3
                  className="font-jakarta font-bold text-[14.5px] mb-2"
                  style={{ color: "#061A12" }}
                >
                  {faq.q}
                </h3>
        ...
        <div className="max-w-[720px] mx-auto">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 4px 20px rgba(6,26,18,0.06)",
            }}
          >
            <PartnerForm />
          </div>
