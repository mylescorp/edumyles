...
import { Users, TrendingUp, CheckCircle2, ArrowRight, Calculator, Shield, Clock, DollarSign } from "lucide-react";

export const metadata: Metadata = {
  title: "How Kenyan Schools Manage Payroll Efficiently - Complete Guide",
  description: "Learn how Kenyan schools are streamlining payroll management with automated systems, KRA compliance, and staff satisfaction. Complete guide for 2026.",
};
      ...
      >
        ...
        <div className="relative max-w-[800px] mx-auto">
          ...
          <div className="max-w-[800px]">
            ...
            >
              How Kenyan Schools{" "}
              <span style={{ color: "#E8A020" }}>Manage Payroll</span>
            </h1>
            ...
            <p 
              ...
              style={{ color: "#A8E6C3" }}
            >
              Discover how Kenyan schools are revolutionizing payroll management with automated systems, 
              ensuring KRA compliance while boosting staff satisfaction.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="mb-12">
            <p className="font-jakarta text-lg leading-[1.8] mb-6" style={{ color: "#374151" }}>
              Managing payroll for Kenyan schools comes with unique challenges: complex tax calculations, 
              KRA compliance requirements, multiple pay scales, and the need for absolute accuracy. 
              Yet many schools still rely on manual processes that are time-consuming and error-prone.
            </p>
            
            <p className="font-jakarta text-lg leading-[1.8] mb-6" style={{ color: "#374151" }}>
              Modern payroll management systems are transforming how schools handle staff compensation, 
              from automated tax calculations to seamless integration with school management platforms. 
              Here&apos;s how leading Kenyan schools are getting it right.
            </p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={issue} className="flex items-center gap-3 p-3 rounded-lg" style={{ background: "#FEF2F2", border: "1px solid #fecaca" }}>
                      <span className="text-red-500 text-lg">✕</span>
                      <span className="font-jakarta text-sm" style={{ color: "#991b1b" }}>{issue}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={feature} className="flex items-center gap-3 p-3 rounded-lg" style={{ background: "#F0FDF4", border: "1px solid #bbf7d0" }}>
                      <CheckCircle2 className="w-5 h-5 flex-shrink-0" style={{ color: "#16a34a" }} />
                      <span className="font-jakarta text-sm" style={{ color: "#15803d" }}>{feature}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {[
                {
                  ...
                  description: "PAYE, NHIF, NSSF, and housing levy calculations updated automatically",
                  benefits: ["Real-time tax rates", "Multiple allowances", "Deduction management"]
                },
                {
                  icon: Users,
                  title: "Staff Management",
                  description: "Complete employee profiles with job details, departments, and employment history",
                  benefits: ["Unlimited employees", "Role-based access", "Performance tracking"]
                },
                {
                  icon: DollarSign,
                  title: "Payslip Generation",
                  description: "Professional payslips with detailed breakdowns and digital signatures",
                ...
                },
                {
                  ...
                  description: "Track annual leave, sick days, and absences with automated accruals",
                  benefits: ["Leave balances", "Approval workflows", "Integration calendar"]
                },
                {
                  icon: TrendingUp,
                  title: "Analytics & Insights",
                  description: "Comprehensive payroll analytics with cost trends and budget forecasting",
              ...
              {[
                {
                  ...
                  duration: "1 week",
                  description: "We analyze your current payroll structure, staff data, and KRA compliance requirements.",
                  deliverables: ["Payroll audit", "Tax review", "Compliance gap analysis", "Implementation plan"]
                },
                {
                  phase: "Phase 2: Setup",
                  duration: "2 weeks",
                  description: "Configure payroll system with your staff data, pay scales, and statutory requirements.",
                  deliverables: ["Staff data import", "Pay structure setup", "Tax configuration", "System testing"]
                },
                {
                  phase: "Phase 3: Training",
                  duration: "1 week",
                  description: "Train your finance team on the new system with hands-on workshops and documentation.",
                  deliverables: ["Admin training", "Staff guides", "Process documentation", "Support setup"]
                },
                {
                  phase: "Phase 4: Go-Live",
                  duration: "1 week",
                  description: "Launch the payroll system with parallel run and comprehensive support.",
                  deliverables: ["System launch", "Data validation", "KRA filing support", "Ongoing assistance"]
                }
              ].map((phase) => (
                <div key={phase.phase} className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: "#E8A020", color: "#061A12" }}>
                      <span className="font-jakarta font-bold text-sm">{phase.phase.split(' ')[1]}</span>
                    </div>
                  </div>
                  <div>
              ...
              {[
                {
                  ...
                  challenge: "Manual payroll processing took 5 days per month with frequent errors.",
                  solution: "Implemented EduMyles payroll with automated KRA compliance.",
                  results: "Reduced processing time to 1 day, 100% accuracy, KES 200K annual savings."
                },
                {
                  school: "St. Mary's Girls High",
                  location: "Nairobi",
                  staff: "85 teachers and staff",
                  challenge: "Complex pay scales and multiple statutory deductions were difficult to manage.",
                  solution: "Deployed automated payroll with real-time tax updates.",
                  results: "Staff satisfaction up 40%, zero compliance issues, seamless monthly reporting."
                },
                {
                  school: "Kisumu Boys High",
                  location: "Kisumu",
                  staff: "95 teachers and staff",
                  challenge: "Leave management and payslip distribution were completely manual processes.",
                  solution: "Integrated payroll system with digital payslips and leave tracking.",
                  results: "Leave processing time reduced by 80%, instant payslip access, improved staff morale."
                }
              ].map((story) => (
                <div key={story.school} className="p-6 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="font-jakarta font-bold text-lg mb-1" style={{ color: "#061A12" }}>
                        {story.school}
                      </h3>
                      <span className="text-sm" style={{ color: "#5a5a5a" }}>{story.location} • {story.staff}</span>
                    </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="font-jakarta text-lg mb-6" style={{ color: "#5a5a5a" }}>
              Join 100+ Kenyan schools using EduMyles for automated, KRA-compliant payroll processing.
            </p>
