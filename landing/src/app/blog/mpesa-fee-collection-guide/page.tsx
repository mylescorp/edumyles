...
import { CreditCard, Clock, CheckCircle2, AlertCircle, ArrowRight, Shield, Smartphone, TrendingUp } from "lucide-react";

export const metadata: Metadata = {
  title: "How to Set Up M-Pesa Fee Collection for Your School in Under 30 Minutes",
  description: "A step-by-step guide to integrating M-Pesa Daraja into your EduMyles fee structure and going fully cashless. Complete walkthrough with screenshots and best practices.",
};
          ...
          <div className="max-w-[800px]">
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-jakarta text-sm" style={{ color: "#A8E6C3" }}>Finance</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <p 
              ...
              style={{ color: "#A8E6C3" }}
            >
              A step-by-step guide to integrating M-Pesa Daraja into your EduMyles fee structure 
              and going fully cashless. Transform your school&apos;s fee collection process in under 30 minutes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4" style={{ background: "#ffffff" }}>
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="font-jakarta text-lg leading-[1.8] mb-6" style={{ color: "#374151" }}>
              With EduMyles and M-Pesa integration, you can. This guide will walk you through setting 
              up a complete digital fee collection system that processes payments automatically, 
              sends instant receipts to parents, and gives you real-time visibility into your school&apos;s 
              financial health.
            </p>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={result} className="flex items-center gap-2">
                    ...
                    <span className="font-jakarta text-sm" style={{ color: "#374151" }}>{result}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={item.title} className="flex gap-4 p-4 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style={{ background: "rgba(26,122,74,0.1)" }}>
              ...
              {[
                {
                  ...
                  content: "Visit any Safaricom shop with your business registration documents, ID, and KRA PIN. Request a Paybill number for your school. The process typically takes 24-48 hours.",
                  time: "5 minutes"
                },
                {
                  step: "Step 2", 
                  title: "Get Daraja API Credentials",
                  content: "Go to developer.safaricom.co.ke and register for a developer account. Create a new app and request production API keys for M-Pesa. You'll receive a Consumer Key and Consumer Secret.",
                  time: "10 minutes"
                },
                {
                  step: "Step 3",
                  title: "Configure M-Pesa in EduMyles",
                  content: "Log into your EduMyles dashboard, navigate to Settings > Payment Methods, and select M-Pesa. Enter your Paybill number, Consumer Key, and Consumer Secret. Test the connection.",
                  time: "5 minutes"
                },
                {
                  step: "Step 4",
                  title: "Set Up Fee Structure",
                  content: "Create your fee categories (tuition, boarding, transport, etc.) and assign amounts per class. EduMyles will automatically calculate totals per student.",
                  time: "8 minutes"
                },
                {
                  step: "Step 5",
                  title: "Enable Parent Notifications",
                  content: "Configure automatic SMS and email notifications for payment confirmations, reminders, and receipts. Parents will receive instant payment alerts.",
                  time: "2 minutes"
                }
              ].map((step) => (
                <div key={step.step} className="border-l-4 pl-6" style={{ borderColor: "#E8A020" }}>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-jakarta text-sm" style={{ color: "#5a5a5a" }}>{step.time}</span>
                  </div>
              ...
              {[
                {
                  ...
                  description: "Before going live, test the system with small payments (KES 100-500) to ensure everything works smoothly."
                },
                {
                  title: "Train Your Finance Team",
                  description: "Conduct a 30-minute training session with your bursar and finance staff on the new system."
                },
                {
                  title: "Communicate with Parents",
                  description: "Send a detailed notice to parents explaining the new payment system and benefits."
                },
                {
                  title: "Set Up Daily Reconciliation",
                  description: "Schedule daily reconciliation of M-Pesa transactions with your EduMyles records."
                }
              ].map((practice) => (
