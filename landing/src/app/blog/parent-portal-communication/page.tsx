...
export const metadata: Metadata = {
  ...
  description:
    "Schools using the parent portal see fewer WhatsApp enquiries, faster fee payments, and more engaged parents. Discover the communication revolution in Kenyan schools.",
};
      ...
      >
        ...
        <div className="relative max-w-[800px] mx-auto">
          ...
          <div className="max-w-[800px]">
            ...
            >
              Parent Portal Reduces SMS Costs <span style={{ color: "#E8A020" }}>by 60%</span>
            </h1>
            ...
            <p className="font-jakarta text-lg leading-[1.7]" style={{ color: "#A8E6C3" }}>
              Schools using the parent portal see fewer WhatsApp enquiries, faster fee payments, and
              more engaged parents. Discover the communication revolution in Kenyan schools.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="font-jakarta text-lg leading-[1.8] mb-6" style={{ color: "#374151" }}>
              ...
              that actually saves money while improving parent satisfaction? That&apos;s exactly
              what the EduMyles Parent Portal delivers.
            </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Office staff spend 3-4 hours daily answering parent calls about grades, fees, and attendance.",
                    },
                    {
                      icon: MessageSquare,
                      title: "WhatsApp Chaos",
                      description:
                        "Multiple WhatsApp groups with mixed conversations, important messages get lost.",
                    },
                    {
                      icon: Mail,
                      title: "Expensive SMS",
                      description:
                        "Bulk SMS for every notification costs KES 50,000+ monthly with declining engagement.",
                    },
                    {
                      icon: Clock,
                      title: "Delayed Information",
                      description:
                        "Parents wait days for information that should be instantly available.",
                    },
                  ].map((problem) => (
                    <div
                      key={problem.title}
                  ...
                  {[
                    {
                      ...
                      description:
                        "Parents access grades, fees, and attendance 24/7 without calling the school.",
                    },
                    {
                      icon: Shield,
                      title: "Secure Messaging",
                      description:
                        "Direct messaging to teachers with automated routing and response tracking.",
                    },
                    {
                      icon: TrendingUp,
                      title: "Smart Notifications",
                      description:
                        "Push notifications only for important updates, reducing notification fatigue.",
                    },
                    {
                      icon: Users,
                      title: "Real-Time Updates",
                      description:
                        "Instant access to current information, no more waiting for report cards.",
                    },
                  ].map((solution) => (
                    <div
                      key={solution.title}
              ...
              {[
                {
                  ...
                  description:
                    "Parents see grades as soon as teachers post them, with detailed breakdown by subject and competency.",
                ...
                },
                {
                  ...
                  description:
                    "Clear view of outstanding fees, payment history, and instant M-Pesa payment options.",
                ...
                },
                {
                  ...
                  description:
                    "Daily attendance records with absence alerts and monthly attendance summaries.",
                ...
                },
                {
                  ...
                  description:
                    "Secure messaging to specific teachers with read receipts and response tracking.",
                ...
                },
                {
                  ...
                  description:
                    "View upcoming assignments, deadlines, and project requirements with submission tracking.",
                ...
                },
                {
                  ...
                  description:
                    "Instant access to current and historical report cards with downloadable PDF versions.",
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    >
                      <span className="font-jakarta text-sm" style={{ color: "#7f1d1d" }}>
                        {item.item}
                      </span>
                      <span className="font-jakarta font-bold" style={{ color: "#991b1b" }}>
                        {item.cost}
                      </span>
                    </div>
                  ))}
                ...
                <div className="mt-4 pt-4 border-t" style={{ borderColor: "#fecaca" }}>
                  <div className="flex justify-between items-center">
                    <span className="font-jakarta font-bold text-lg" style={{ color: "#991b1b" }}>
                      Total Monthly Cost
                    </span>
                    <span className="font-jakarta font-bold text-xl" style={{ color: "#991b1b" }}>
                      KES 160,000
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    >
                      <span className="font-jakarta text-sm" style={{ color: "#065f46" }}>
                        {item.item}
                      </span>
                      <span className="font-jakarta font-bold" style={{ color: "#064e3b" }}>
                        {item.cost}
                      </span>
                    </div>
                  ))}
                ...
                <div className="mt-4 pt-4 border-t" style={{ borderColor: "#a7f3d0" }}>
                  <div className="flex justify-between items-center">
                    <span className="font-jakarta font-bold text-lg" style={{ color: "#064e3b" }}>
                      Total Monthly Cost
                    </span>
                    <span className="font-jakarta font-bold text-xl" style={{ color: "#064e3b" }}>
                      KES 38,000
                    </span>
                  </div>
                  <div className="mt-2">
                    <span className="font-jakarta font-bold text-sm" style={{ color: "#065f46" }}>
                      Monthly Savings: KES 122,000 (76% reduction)
                    </span>
                  </div>
                </div>
              </div>
