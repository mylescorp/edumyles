...
export const metadata: Metadata = {
  ...
  description: "The algorithm behind EduMyles timetable engine — and why it saves school coordinators 2 full days every term. Learn how automatic scheduling works.",
};
        ...
        <div className="relative max-w-[800px] mx-auto">
          ...
          <div className="max-w-[800px]">
            ...
            >
              ...
              <span style={{ color: "#E8A020" }}>Saves 2 Days</span>
            </h1>
            
            <div className="flex flex-wrap gap-4 mb-6">
              <div className="flex items-center gap-2">
                <CalendarDays className="w-5 h-5" style={{ color: "#E8A020" }} />
                <span className="font-jakarta text-sm" style={{ color: "#A8E6C3" }}>Operations</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-5 h-5" style={{ color: "#E8A020" }} />
                <span className="font-jakarta text-sm" style={{ color: "#A8E6C3" }}>7 min read</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="mb-12">
            <p className="font-jakarta text-lg leading-[1.8] mb-6" style={{ color: "#374151" }}>
              Creating a school timetable is one of the most complex challenges in educational administration. 
              With dozens of teachers, hundreds of students, limited classrooms, and countless constraints, 
              it&apos;s a puzzle that would take most coordinators weeks to solve manually.
            </p>
            
            <p className="font-jakarta text-lg leading-[1.8] mb-6" style={{ color: "#374151" }}>
              EduMyles solves this problem in minutes. Our automatic timetable generation engine uses advanced 
              algorithms to create optimal schedules that respect every constraint while maximizing efficiency. 
              Here&apos;s how it works and why it&apos;s transforming school operations.
            </p>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={impact} className="flex items-center gap-2">
                    ...
                    <span className="font-jakarta text-sm" style={{ color: "#374151" }}>{impact}</span>
                  </li>
                ))}
              </ul>
            </div>
              ...
              {[
                {
                  ...
                  description: "Teachers have availability preferences, subjects require specific rooms, and students need breaks. The human brain can't track all these variables simultaneously.",
                  complexity: "High"
                },
                {
                  title: "Exponential Possibilities",
                  description: "With 30 teachers, 40 classrooms, and 8 periods daily, there are millions of possible combinations. Manual selection can't find the optimal solution.",
                  complexity: "Very High"
                },
                {
                  title: "Change Management",
                  description: "When one teacher gets sick or a classroom becomes unavailable, the entire schedule needs re-evaluation. Manual adjustments create cascading conflicts.",
                  complexity: "Medium"
                },
                {
                  title: "Optimization Blind Spots",
                  description: "Human schedulers focus on avoiding conflicts but miss optimization opportunities like better room utilization or teacher preference matching.",
                  complexity: "Medium"
                }
              ].map((problem) => (
                <div key={problem.title} className="flex gap-4 p-4 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style={{ 
                    background: problem.complexity === 'Very High' ? "#ef4444" : 
                               problem.complexity === 'High' ? "#f97316" : "#eab308" 
                  }}>
                  ...
                  <div>
                    ...
                    <span className="text-xs mt-2 inline-block px-2 py-1 rounded-full" style={{ 
                      background: problem.complexity === 'Very High' ? "#fef2f2" : 
                                 problem.complexity === 'High' ? "#fff7ed" : "#fefce8",
                      color: problem.complexity === 'Very High' ? "#991b1b" : 
                             problem.complexity === 'High' ? "#9a3412" : "#854d0e"
                    }}>
              ...
              {[
                {
                  ...
                  description: "The system first gathers all constraints: teacher availability, subject requirements, room specifications, student groupings, and school policies. Each constraint is validated for completeness and consistency.",
                ...
                },
                {
                  ...
                  description: "Advanced algorithms analyze resource utilization patterns, identifying optimal room assignments, teacher workloads, and time slot distributions based on historical data and best practices.",
                ...
                },
                {
                  ...
                  description: "Using a hybrid of constraint satisfaction and optimization algorithms, the system generates thousands of potential schedules, each respecting all hard constraints while maximizing soft constraints.",
                ...
                },
                {
                  ...
                  description: "The system evaluates each generated schedule against multiple objectives: teacher satisfaction, room efficiency, student experience, and operational practicality.",
                ...
                },
                {
                  ...
                  description: "The top 3 schedules are presented to administrators with detailed analytics. Human preferences and institutional knowledge are applied to select the final schedule.",
                ...
                <div key={step.step} className="border-l-4 pl-6" style={{ borderColor: "#E8A020" }}>
                  ...
                  <p className="font-jakarta text-base leading-[1.7] mb-3" style={{ color: "#374151" }}>
                    {step.description}
                  </p>
                  <div className="p-3 rounded-lg" style={{ background: "rgba(26,122,74,0.1)" }}>
                    <span className="font-mono text-xs" style={{ color: "#1A7A4A" }}>{step.process}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={category.category} className="p-5 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  <div className="flex items-center gap-3 mb-3">
              ...
              {[
                {
                  ...
                  description: "CSP algorithms treat timetabling as a constraint satisfaction problem, using backtracking and forward checking to find valid solutions.",
                  benefit: "Guarantees conflict-free schedules"
                },
                {
                  technology: "Genetic Algorithms",
                  role: "Optimization engine",
                  description: "Evolutionary algorithms explore millions of schedule combinations to find optimal solutions that maximize multiple objectives.",
                  benefit: "Finds schedules humans would miss"
                },
                {
                  technology: "Machine Learning",
                  role: "Pattern recognition and prediction",
                  description: "ML models analyze historical timetables to identify successful patterns and predict optimal scheduling decisions.",
                  benefit: "Improves over time with school data"
                },
                {
                  technology: "Graph Theory",
                  role: "Conflict detection and resolution",
                  description: "Complex constraint relationships are modeled as graphs, enabling efficient detection and resolution of scheduling conflicts.",
                  benefit: "Handles complex constraint interactions"
                },
                {
                  technology: "Multi-Objective Optimization",
                  role: "Balance competing priorities",
                  description: "Pareto optimization balances multiple objectives like teacher satisfaction, room efficiency, and student experience.",
                  benefit: "Creates balanced, practical schedules"
                }
              ].map((tech) => (
                <div key={tech.technology} className="flex gap-4 p-4 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  ...
                  <div>
                    <h3 className="font-jakarta font-bold text-base mb-1" style={{ color: "#061A12" }}>
                      {tech.technology}
                    </h3>
                    <p className="font-jakarta text-xs font-semibold mb-1" style={{ color: "#1A7A4A" }}>
                      {tech.role}
                    </p>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              {[
                { metric: "Processing Time", value: "3-5 minutes", description: "From data input to final schedule" },
                { metric: "Conflict Rate", value: "0%", description: "Guaranteed conflict-free schedules" },
                { metric: "Teacher Satisfaction", value: "94%", description: "Based on preference matching" },
                { metric: "Room Utilization", value: "87%", description: "Optimal space usage" },
                { metric: "Schedule Stability", value: "96%", description: "Minimal changes needed" },
                { metric: "User Acceptance", value: "98%", description: "Schools continue using automated schedules" }
              ].map((stat) => (
                <div key={stat.metric} className="text-center p-6 rounded-xl" style={{ background: "linear-gradient(135deg, #F3FBF6 0%, #E8F5EE 100%)", border: "1px solid rgba(26,122,74,0.2)" }}>
                  <div className="font-jakarta font-bold text-2xl mb-2" style={{ color: "#1A7A4A" }}>
                    {stat.value}
                  </div>
            ...
            <div className="p-6 rounded-2xl" style={{ background: "linear-gradient(135deg, #061A12 0%, #0F4C2A 100%)", color: "#ffffff" }}>
              <h3 className="font-jakarta font-bold text-lg mb-4" style={{ color: "#E8A020" }}>
                Scale Performance
              </h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-jakarta font-semibold text-base mb-3">Small Schools (200-500 students)</h4>
                  <ul className="space-y-2">
                    {["Processing: 1-2 minutes", "Teachers: 15-30", "Classrooms: 10-20"].map((item) => (
                ...
                <div>
                  <h4 className="font-jakarta font-semibold text-base mb-3">Large Schools (1000+ students)</h4>
                  <ul className="space-y-2">
                ...
                <div key={story.school} className="p-6 rounded-2xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <span className="text-sm" style={{ color: "#5a5a5a" }}>{story.size}</span>
                    </div>
              ...
              {[
                {
                  ...
                  description: "Machine learning models that predict optimal schedules based on historical performance and emerging patterns.",
                  timeline: "Q2 2026"
                },
                {
                  feature: "Real-Time Dynamic Rescheduling",
                  description: "Instant automatic adjustments when teachers call in sick or rooms become unavailable.",
                  timeline: "Q3 2026"
                },
                {
                  feature: "Student Preference Integration",
                  description: "Consider student learning preferences and energy patterns for optimal subject timing.",
                  timeline: "Q4 2026"
                },
                {
                  feature: "Cross-School Resource Sharing",
                  description: "Enable resource sharing between schools for optimal community-wide utilization.",
                  timeline: "Q1 2027"
                }
              ].map((feature) => (
                <div key={feature.feature} className="p-5 rounded-xl" style={{ background: "#F9FAFB", border: "1px solid #e5e7eb" }}>
                  ...
                  <div className="text-xs px-2 py-1 rounded-full" style={{ background: "rgba(26,122,74,0.1)", color: "#1A7A4A" }}>
                    🚀 {feature.timeline}
                  </div>
                </div>
              ))}
