...
const solutions = [
  {
    ...
    description: "CBC-ready management system for PP1 to Class 8 with automated assessments and parent communication.",
  ...
  },
  {
    ...
    description: "Comprehensive KCSE management with advanced timetabling, HR payroll, and performance analytics.",
  ...
  },
  {
    ...
    description: "IGCSE & IB curriculum support with SSO, white-label options, and global standards compliance.",
  ...
  },
  {
    icon: Building2,
    title: "School Groups",
    description: "Multi-campus management with consolidated reporting, centralized administration, and scalable infrastructure.",
      ...
      >
        ...
        <div className="relative max-w-[1200px] mx-auto text-center">
          <div className="max-w-[800px] mx-auto">
            ...
            >
              Solutions Built for{" "}
              <span style={{ color: "#E8A020" }}>Every School</span>
            </h1>
            <p 
              className="font-jakarta text-xl leading-[1.7] mb-8"
              style={{ color: "#A8E6C3" }}
            >
              From primary schools to international institutions, EduMyles adapts to your unique needs. 
              Streamline administration, enhance learning, and empower your entire school community.
            </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            >
              ...
              <span style={{ color: "#E8A020" }}>Your Institution</span>
            </h2>
            <p 
              className="font-jakarta text-lg max-w-[700px] mx-auto"
              style={{ color: "#5a5a5a", lineHeight: "1.7" }}
            >
              Each solution is specifically designed to address the unique challenges and requirements 
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p 
              ...
              style={{ color: "#5a5a5a", lineHeight: "1.7" }}
            >
              Experience the difference with our comprehensive school management platform 
      ...
      <section className="py-20 px-4" style={{ background: "#061A12" }}>
        <div className="max-w-[800px] mx-auto text-center">
          ...
          >
            ...
            <span style={{ color: "#E8A020" }}>School Management?</span>
          </h2>
          <p 
            className="font-jakarta text-lg mb-8"
            style={{ color: "#A8E6C3", lineHeight: "1.7" }}
          >
            Join 1000+ schools across East Africa that have already streamlined their operations 
            and enhanced educational outcomes with EduMyles.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/book-demo"
