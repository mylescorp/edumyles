...
const releases: Release[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      { tag: "improved", text: "Bulk SMS now supports Africa's Talking Unicode templates" },
      { tag: "fixed", text: "Fixed attendance report date range filter" },
      { tag: "security", text: "SOC 2 Type I audit completed" },
    ],
  },
  {
    version: "v2.2.0",
  ...
  },
  {
    ...
    date: "November 2025",
    changes: [
      { tag: "new", text: "Full platform rebuild on real-time Convex architecture" },
      { tag: "new", text: "Role-based access control (14 roles)" },
      { tag: "new", text: "Multi-tenant school isolation" },
      { tag: "new", text: "All 11 modules available" },
