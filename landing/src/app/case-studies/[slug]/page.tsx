...
const studies = [
  {
    ...
    timeline: [
      {
        day: "Day 1",
        event: "Admin team training (4 hours). All staff and class accounts created.",
      },
      {
        day: "Day 3",
        event: "M-Pesa Daraja integration live and tested. First payments auto-reconciled.",
      },
  ...
  },
  {
    ...
    challenge:
      "End-of-term reporting at St. Francis meant three teachers working an entire weekend to manually compile and print 1,200 report cards. Errors were common — wrong student names, incorrect subject scores, missing teacher signatures. Parents complained. The Deputy Principal described the process as 'the most stressful three days of the year, every term.'",
    solution:
      "EduMyles gradebook was rolled out at the start of the academic year. Teachers entered grades throughout the term — in class, on their phones, or at home. At term end, the Deputy Principal clicked 'Generate Reports' and all 1,200 report cards were ready in under 3 hours, with zero errors.",
    timeline: [
      {
        day: "Week 1",
        event: "All 47 teachers trained on the EduMyles mobile gradebook in two sessions.",
      },
      {
        day: "Week 2",
        event: "Class registration complete. All 1,200 students enrolled with subject mappings.",
      },
      {
        day: "Mid-Term",
        event: "First mid-term grades entered. Teachers reported 30 min/week vs 3 hrs previously.",
      },
      {
        day: "Term End",
        event: "All reports generated in 3 hours. Zero errors. First fully digital end-of-term.",
      },
    ],
    quote:
      "The first term we used EduMyles, I couldn't believe it. Friday afternoon, I clicked generate, and all 1,200 reports were done by 5pm. No more weekend work.",
  ...
  },
  {
    ...
    challenge:
      "Brookside Prep ran on paper registers, WhatsApp parent groups, and email-based grade updates. There was no central system. The Head of School wanted to enter the new academic year fully digital — and the start of term was 11 days away.",
    solution:
      "EduMyles rapid deployment: Day 1 admin training, Day 3 teacher onboarding, Day 7 parent portal invitations, Day 11 first fully digital school day. The implementation team worked alongside the school's leadership every step of the way.",
    timeline: [
      {
        day: "Day 1",
        event: "Admin and leadership training. School structure, classes, and subjects configured.",
      },
      ...
      {
        day: "Day 9",
        event: "73% of parents had activated their portal. Real-time attendance SMS live.",
      },
      {
        day: "Day 11",
        event: "First fully digital school day. 98% parent portal adoption by end of week 2.",
      },
    ],
    quote:
      "We told our parents we were going digital and they were nervous. Within a week, 98% of them were using the app. It sells itself.",
    ...
    <div style={{ color: "#212121" }}>
      ...
      >
        ...
        <div className="relative max-w-[1000px] mx-auto w-full">
          ...
          <div
            className="inline-block font-jakarta font-semibold text-[12px] mb-4 px-4 py-1.5 rounded-full"
            style={{
      ...
      <div className="max-w-[1000px] mx-auto px-6 py-16 flex flex-col gap-12">
        {/* Challenge */}
        <section>
          <h2 className="font-display font-bold text-[22px] mb-4" style={{ color: "#061A12" }}>
            The Challenge
          </h2>
          <p className="font-jakarta text-[15px] leading-[1.9]" style={{ color: "#5a5a5a" }}>
            {study.challenge}
          </p>
        </section>
        ...
        {/* Timeline */}
        <section>
          <h2 className="font-display font-bold text-[22px] mb-6" style={{ color: "#061A12" }}>
          ...
          <div className="flex flex-col gap-3">
            {study.timeline.map((t, i) => (
              ...
              >
                <span
                  className="font-jakarta font-bold text-[12px] px-3 py-1 rounded-full flex-shrink-0"
                  style={{ background: "#E8A020", color: "#061A12" }}
                >
                  {t.day}
                </span>
                <p className="font-jakarta text-[14px] leading-[1.7]" style={{ color: "#374151" }}>
                  {t.event}
                </p>
              </div>
            ))}
        ...
        >
          <p className="font-display italic text-[18px] leading-[1.7] text-white mb-4">
            &ldquo;{study.quote}&rdquo;
          </p>
          <cite
            className="font-jakarta font-semibold text-[13px] not-italic"
            style={{ color: "#E8A020" }}
          >
            {study.quotePerson}
          </cite>
        ...
        {/* Related */}
        <section>
          <h3 className="font-display font-bold text-[20px] mb-5" style={{ color: "#061A12" }}>
            More Case Studies
          </h3>
          <div className="grid sm:grid-cols-2 gap-5">
            {related.map((r) => (
              <Link
                ...
                className="rounded-xl p-6 no-underline transition-all duration-200 hover:-translate-y-0.5 group"
                style={{ background: "#F3FBF6", border: "1px solid #d4eade" }}
              >
                <span
